...
public class ListaProdutosDataSetProvider implements DataSetProvider {
    ...
    public IDataSet provide() throws DataSetException {
        ...
        return new DataSetBuilder()
                ...
                .values(null, "7de0b077875c45bcb4b6fd19f7d46f31", "Teste-2", "Teste-2", Date.from(LocalDate.of(2021, 03, 26).atStartOfDay(ZoneId.systemDefault()).toInstant()), new BigDecimal("100.00"), "Teste-2")
                .build();
